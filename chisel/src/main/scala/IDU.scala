...
//alu op
  ...
  val isSlt  = (isOpImm || (isRop && funct7 === "b0000000".U)) && funct3 === "b010".U
  val isSltu = (isOpImm || (isRop && funct7 === "b0000000".U)) && funct3 === "b011".U
  val isXor  = funct3 === "b100".U && (isOpImm || (isRop && funct7 === "b0000000".U))
  val isOr   = funct3 === "b110".U && (isOpImm || (isRop && funct7 === "b0000000".U))
  val isAnd  = funct3 === "b111".U && (isOpImm || (isRop && funct7 === "b0000000".U))
  val isSll  = funct3 === "b001".U && (isOpImm || (isRop && funct7 === "b0000000".U))
